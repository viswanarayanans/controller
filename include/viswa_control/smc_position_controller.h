#ifndef VISWA_CONTROL_SMC_POSITION_CONTROLLER_H
#define VISWA_CONTROL_SMC_POSITION_CONTROLLER_H
...
#include "viswa_control/parameters.h"
...
namespace viswa_control {
	...
	public:
		...
		void ComputeThrust(Eigen::Vector3d* thrust) const;
