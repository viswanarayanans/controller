...
#ifndef RRC_CONTROL_Rsbv_POSITION_CONTROLLER_H
#define RRC_CONTROL_Rsbv_POSITION_CONTROLLER_H
...
class RsbvPositionControllerParameters {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  RsbvPositionControllerParameters()
      : kbp_(kDefaultkbp),
        kb2_p_(kDefaultkbp),
        K1p_(kDefaultK1p),
        K2p_(kDefaultK2p),
  ...
  Eigen::Vector3d kbp_;
  Eigen::Vector3d kb2_p_;
  Eigen::Vector3d K1p_;
  Eigen::Vector3d K2p_;
  Eigen::Vector3d kbq_;
  Eigen::Vector3d kb2_q_;
  Eigen::Vector3d K1q_;
  Eigen::Vector3d K2q_; 
...
class RsbvPositionController {
 public:
  RsbvPositionController();
  ~RsbvPositionController();
  ...
  RsbvPositionControllerParameters controller_parameters_;
...
#endif // RRC_CONTROL_RSBV_POSITION_CONTROLLER_H
