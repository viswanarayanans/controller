...
class RsbvPositionControllerNode {
 public:
  RsbvPositionControllerNode(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh);
  ~RsbvPositionControllerNode();
...
#endif // RRC_CONTROL_RSB_POSITION_CONTROLLER_NODE_H
