...

{
	...
	ros::Publisher trajectory_pub =
	      n.advertise<trajectory_msgs::MultiDOFJointTrajectory>("/pelican/command/trajectory", 20);
	...
	while (ros::ok()){
		if(command_active_){
				...
				points.push_back(Eigen::Vector3d(0.0, 0.0, 1.0));
				points.push_back(Eigen::Vector3d(0.8, 0.5, 1.0));
				points.push_back(Eigen::Vector3d(0.0, 1.0, 1.1));
				points.push_back(Eigen::Vector3d(-0.5, 0.5, 1.2));
				...
				points.push_back(Eigen::Vector3d(-0.5, 0.5, 1.2));
				points.push_back(Eigen::Vector3d(0.0, 0.0, 1.2));
				points.push_back(Eigen::Vector3d(0.8, 0.5, 1.2));
				start_trajectory(trajectory_pub, points);
				ROS_INFO("Drop second payload");
				points.clear();
		
				ros::Duration(2.0).sleep();
				points.push_back(Eigen::Vector3d(0.8, 0.5, 1.2));
				points.push_back(Eigen::Vector3d(0.0, 1.0, 1.1));
				points.push_back(Eigen::Vector3d(-0.5, 0.5, 1.0));
				points.push_back(Eigen::Vector3d(0.0, 0.0, 1.0));
				start_trajectory(trajectory_pub, points);
