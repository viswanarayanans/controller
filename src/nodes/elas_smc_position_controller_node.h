...
#ifndef RRC_CONTROL_ELAS_SMC_POSITION_CONTROLLER_NODE_H
#define RRC_CONTROL_ELAS_SMC_POSITION_CONTROLLER_NODE_H
...
namespace rrc_control {
	class ElasSmcPositionControllerNode{
	public:
		ElasSmcPositionControllerNode(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh);
		~ElasSmcPositionControllerNode();
