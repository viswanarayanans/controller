...
RsbPositionController::RsbPositionController()
...
void RsbPositionController::InitializeParameters() {
...
void RsbPositionController::SetOdometry(const EigenOdometry& odometry) {
  odometry_ = odometry;
}

void RsbPositionController::SetTrajectoryPoint(
...
// Implementation from the T. Rsb et al. paper
...
double RsbPositionController::Sigmoid(double s, double var_pi) const {
