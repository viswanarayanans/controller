...
euler_backstep_phi = []
euler_backstep_theta = []
euler_backstep_psi = []
# for i in range(len(odom_backstep_ax)):
# 	euler = euler_from_quaternion(np.array([odom_backstep_ax[i], odom_backstep_ay[i], odom_backstep_az[i], odom_backstep_aw[i]]))
# 	euler_backstep_phi.append(euler[0])
# 	euler_backstep_theta.append(euler[1])
# 	euler_backstep_psi.append(euler[2])
