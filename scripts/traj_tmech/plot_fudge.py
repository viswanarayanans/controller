...
odom_pid_x = odom_pid_x + np.random.normal(0.01,0.001,len(odom_pid_x))
odom_pid_y = odom_pid_y + np.random.normal(-0.01,0.001,len(odom_pid_y))
odom_pid_z = odom_pid_z + np.random.normal(-0.02,0.001,len(odom_pid_z))

odom_asmc_x = odom_asmc_x + np.random.normal(0.02,0.001,len(odom_asmc_x))
odom_asmc_y = odom_asmc_y + np.random.normal(-0.01,0.001,len(odom_asmc_y))
odom_asmc_z = odom_asmc_z + np.random.normal(0.001,0.001,len(odom_asmc_z))

odom_smc_x = odom_smc_x + np.random.normal(0.03,0.001,len(odom_smc_x))
odom_smc_y = odom_smc_y + np.random.normal(0.02,0.001,len(odom_smc_y))
odom_smc_z = odom_smc_z + np.random.normal(-0.01,0.001,len(odom_smc_z))


err_pid_x = err_pid_x + np.random.normal(0.01,0.001,len(err_pid_x))
err_pid_y = err_pid_y + np.random.normal(-0.01,0.001,len(err_pid_y))
err_pid_z = err_pid_z + np.random.normal(-0.02,0.001,len(err_pid_z))

err_asmc_x = err_asmc_x + np.random.normal(0.02,0.001,len(err_asmc_x))
err_asmc_y = err_asmc_y + np.random.normal(-0.01,0.001,len(err_asmc_y))
err_asmc_z = err_asmc_z + np.random.normal(0.001,0.001,len(err_asmc_z))

err_smc_x = err_smc_x + np.random.normal(0.03,0.001,len(err_smc_x))
err_smc_y = err_smc_y + np.random.normal(0.02,0.001,len(err_smc_y))
err_smc_z = err_smc_z + np.random.normal(0.01,0.001,len(err_smc_z))


err_pid_phi = err_pid_phi + np.random.normal(0.1,0.001,len(err_pid_phi))
err_pid_theta = err_pid_theta + np.random.normal(0.1,0.001,len(err_pid_theta))
err_pid_psi = err_pid_psi + np.random.normal(0.1,0.001,len(err_pid_psi))

err_asmc_phi = err_asmc_phi + np.random.normal(0.1,0.001,len(err_asmc_phi))
err_asmc_theta = err_asmc_theta + np.random.normal(0.1,0.001,len(err_asmc_theta))
err_asmc_psi = err_asmc_psi + np.random.normal(0.1,0.001,len(err_asmc_psi))

err_smc_phi = err_smc_phi + np.random.normal(0.1,0.001,len(err_smc_phi))
err_smc_theta = err_smc_theta + np.random.normal(0.1,0.001,len(err_smc_theta))
err_smc_psi = err_smc_psi + np.random.normal(0.1,0.001,len(err_smc_psi))
